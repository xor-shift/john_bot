...
struct connection {
    ...
    auto make_request(std::string_view endpoint, boost::json::object const& body = {}, request_verb verb = request_verb::get) -> boost::asio::awaitable<anyhow::result<boost::json::value>>;
